...
cursor.execute('''INSERT INTO cutchart (cu_ma_id,cu_me_id, cu_co_id, cu_mt_id, cu_th_id, cu_op_id, cu_ga_id, cu_qu_id, cu_pierce_ht, cu_pierce_delay, cu_cut_ht, 
                  ...
                  VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)''', (m_ma_id, m_me_id, m_co_id, m_mt_id, m_th_id, m_op_id, m_ga_id, m_qu_id, 
                         m_pierce_ht, m_pierce_dly, m_cut_ht, m_cut_spd, m_volts, m_kerf_width, m_thc_delay, m_plung_rate, m_puddle_ht, m_amps, m_pressure ))   
